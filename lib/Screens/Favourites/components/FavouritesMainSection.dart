...
class FavouritesMainSection extends StatefulWidget {
  const FavouritesMainSection({super.key});

  @override
  State<FavouritesMainSection> createState() => _FavouritesMainSectionState();
}

class _FavouritesMainSectionState extends State<FavouritesMainSection> {
